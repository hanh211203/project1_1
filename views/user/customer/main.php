...
<div id="sidebar-collapse" class="box1 col-md-6 col-lg-2">
    <div class="list-group" >
        ...
        <a href="?controller=customer" class="list-group-item list-group-item-action" id="maincolor">Customer Management</a>
        ...
        <div class="container">
            <h1 style="text-align:center">CUSTOMERS LIST</h1> 
                ...
                <table class="table">
                    ...
                    <tr>
                        <th scope="row"><?= $stt?></th>
                        <td><?= $item['cus_first_name']?></td>
                        <td><?= $item['cus_last_name']?></td>
