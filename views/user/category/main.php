...
<div id="sidebar-collapse" class="box1 col-md-6 col-lg-2">
    <div class="list-group" >
        ...
        <a href="?controller=category" class="list-group-item list-group-item-action" id="maincolor">Category Management</a>
...
<div class="box1 col-md-6 col-lg-10 col-lg-offset-2 main">
    ...
    <div class="row">
        <div class="container">
            ...
            <div class="row">  
                <div>
                    <a class="btn btn-success m-5" id="button" href="?controller=<?=$controller?>&action=create" style="color:black">+ Add the category</a>
                </div>   
            </div>
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        <th scope="row"><?= $stt?></th>
                        <td><?= $item['cat_name']?></td>
                        <td><a href="?controller=<?= $controller ?>&action=edit&cat_id=<?= $item['cat_id'] ?>" class="btn btn-info">Edit</a></td>
                        <td><a onClick="confirm('Are you sure delete the adminitrator?')" href="?controller=category&action=destroy&cat_id=<?= $item['cat_id'] ?>" class="btn btn-danger" onClick="confirm">Delete</a></td>
                    </tr>                   
                    <?php
                    $stt++;}
                    ?>
