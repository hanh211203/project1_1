        ...
        <div >
          <div class="box1 col-md-6 col-lg-4">
            <div class="mb-3">
              ...
              <input type="text" id="adm_first_name" name="adm_first_name" class="form-control" placeholder="Enter firstname" required>
            </div>
            <div class="mb-3">
              <label for="adm_last_name" class="form-label"><b>Lastname</b></label>
              <input type="text" id="adm_last_name" name="adm_last_name" class="form-control" placeholder="Enter lastname" required> 
            </div>
            <div class="mb-3">
              <label for="adm_phone" class="form-label"><b>Phone</b></label>
              <input type="number" id="adm_phone" name="adm_phone" class="form-control" placeholder="Phone number" required> 
            </div>
            <div class="mb-3">
              <label for="adm_email" class="form-label"><b>Email</b></label>
              <input type="text" id="adm_email" name="adm_email" class="form-control" placeholder="Email" required> 
            </div>
          </div>
          <div class="box1 col-md-6 col-lg-4">
            <div class="mb-3">
              <label for="adm_address" class="form-label"><b>Address</b></label>
              <input type="text" id="adm_address" name="adm_address" class="form-control" placeholder="Address" required> 
            </div>
