...
<div class="box1 col-md-6 col-lg-10 col-lg-offset-2 main">
    ...
    <div class="row">
        <div class="container">
            ...
            <div class="row">  
                <div>
                    <a class="btn btn-success m-5" id="button" href="?controller=<?=$controller?>&action=create" style="color:black">+ Add the member</a>
                </div>   
            </div>
                <table class="table">
                    ...
                    <tr>
                        ...
                        <td><?= $item['username']?></td>
                        <td><?= $item['password']?></td>
                        <td><a href="?controller=<?= $controller ?>&action=edit&adm_id=<?= $item['adm_id'] ?>" class="btn btn-info">Edit</a></td>
                        <td><a onClick="confirm('Are you sure delete the adminitrator?')" href="?controller=admin&action=destroy&adm_id=<?= $item['adm_id'] ?>" class="btn btn-danger" onClick="confirm">Delete</a></td>
