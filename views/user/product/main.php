...
<div class="box1 col-md-6 col-lg-10 col-lg-offset-2 main">
    ...
    <div class="row">
        <div class="container">
            ...
            <div class="row">  
                <div>
                    <a class="btn btn-success m-5" id="button" href="?controller=product&action=create" style="color:black">+ Add the product</a>
                </div>   
            </div>
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?= $item['prd_name']?></td>
                        <td><?= $item['cat_id']?></td>
                        <td><img src="public/images/<?= $item['image']; ?>"></td>
                        <td><?= $item['weight']?></td>
                        ...
                        <td><a href="?controller=product&action=edit&prd_id=<?= $item['prd_id'] ?>" class="btn btn-info">Edit</a></td>
                        <td><a onClick="confirm('Are you sure delete the product?')" href="?controller=product&action=destroy&prd_id=<?= $item['prd_id'] ?>" class="btn btn-danger" onClick="confirm">Delete</a></td>
                    </tr>                   
                    <?php
                    $stt++;}
                    ?>
