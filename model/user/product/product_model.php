...
function store(){
    ...
    $sql = "INSERT INTO product (prd_name,cat_id,image,weight,price,uses,recommended_use,expiry,quantity)
            VALUES ('$prd_name','$cat_id',' $image','$weight',$price,'$uses',' $recommended_use',$expiry,$quantity)";
